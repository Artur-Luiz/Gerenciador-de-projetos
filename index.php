        ...
        <div class="form_project">
            <form action="database/newProject.php" method="POST">
                <fieldset>
                    ...
                    <input class="btn" type="submit" name="submit" id='submit' value="Criar">
                </fieldset>
            </form>
        </div>
        ...
        <div class="form_activities">
            <form action="database/newActivity.php" method="POST">
                <fieldset>
                    ...
                    <input class="btn" type="submit" name="submit" value="Criar">
                </fieldset>
            </form>
        </div>
    </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>" . $late . "</td>";
                        echo "<td><a href='database/deleteProject.php?id=$id' class='remove'> <img src='style/src/img/bin.png'> </a></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
